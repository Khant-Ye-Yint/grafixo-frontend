...
import YoutubeLogo from '../../public/images/logo/youtube.png';
...
const Footer = () => {
	return (
		<div className='w-full grid place-items-center  bg-darkGray  laptop:px-footer tablet:pt-tabletContain tablet:px-tabletContain phone:px-phone phone:pt-10 text-lightGray font-montserrat relative'>
			<div className='flex tablet:w-full phone:w-2/3 tablet:flex-row  tablet:justify-between laptop:flex-row phone:flex-col items-start laptop:justify-between laptop:items-start phone:space-y-16 laptop:space-y-0 tablet:space-y-0 '>
