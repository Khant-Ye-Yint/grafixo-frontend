...
const Testamonial = () => {
	return (
		...
		>
			<div className='w-full absolute laptop:p-contain tablet:p-tabletContain laptop:space-y-24 tablet:space-y-14 phone:p-phone phone:space-y-10 flex flex-col justify-center items-center transformYCenter'>
